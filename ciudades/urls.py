...
from ciudades.geostats.views import login_view, do_login_view, sign_up_view, create_entity_view, user_entity_detail_view,\
    logout_view, create_entities_view, user_home_view, entities_list_view, user_stats_view
